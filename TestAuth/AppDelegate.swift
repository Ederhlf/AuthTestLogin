...
//         }
//
        let googlelogged = GIDSignIn.sharedInstance.hasPreviousSignIn()
        let token: Bool = ((AccessToken.current?.isExpired) != nil)
        
        if token == true || googlelogged  == true {
        ...
        let clientID = (FirebaseApp.app()?.options.clientID) ?? String()
...
//    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "TestAuth")
